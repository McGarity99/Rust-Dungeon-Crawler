...
fn main() -> BError {
    let context = BTermBuilder::new()   //create generic terminal and specify attributes directly
        ...
        .with_simple_console(DISPLAY_WIDTH, DISPLAY_HEIGHT, "dungeonfont2.png")  //add a console using the specified dimensions and the named tile graphics file
        .with_simple_console_no_bg(DISPLAY_WIDTH, DISPLAY_HEIGHT, "dungeonfont2.png")    //add a second console with no background so transparency shows through it

...
fn main() -> BError {
    let context = BTermBuilder::new()   //create generic terminal and specify attributes directly
        ...
        .with_font("dungeonfont2_green.png", 32, 32)
        .with_font("terminal8x8.png", 8, 8)
        .with_simple_console(DISPLAY_WIDTH, DISPLAY_HEIGHT, "dungeonfont2_green.png")  //add a console using the specified dimensions and the named tile graphics file
        .with_simple_console_no_bg(DISPLAY_WIDTH, DISPLAY_HEIGHT, "dungeonfont2_green.png")    //add a second console with no background so transparency shows through it
